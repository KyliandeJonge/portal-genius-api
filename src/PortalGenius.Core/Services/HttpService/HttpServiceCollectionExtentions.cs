...
public static class HttpServiceCollectionExtentions
{
    ...
    ///     This method accepts a <paramref name="clientName" /> to specify whichs <see cref="HttpClient" /> should be used in
    ///     the <see cref="HttpService" />.
    /// </summary>
    ...
    public static IServiceCollection AddHttpService(this IServiceCollection services, string clientName)
    {
        ...
        services.Configure<HttpServiceOptions>(options => { options.HttpClientName = clientName; });
